            ...
            <div class="col-md-12">
             <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD0. Kontento ko sa serbisyo nga akong nakuha</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD1. Gigugol nako ang igo nga oras sa akong transaksyon</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD2. Gisunod sa opisina ang mga kinahanglanon ug lakang sa transaksyon base sa gihatag nga kasayuran</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD3. Ang mga lakang (lakip ang pagbayad) nga kinahanglan nakong buhaton alang sa akong transaksyon sayon ​​ug yano</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD4. Dali ra nakong nakit-an ang impormasyon bahin sa akong transaksyon gikan sa opisina o sa website niini</td>
