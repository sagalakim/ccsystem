...
.background-container {
  ...
  <div>
    ...
    <form action="{{route('submitsurveyenglish')}}" method="Post" enctype="multipart/form-data">
    @csrf
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <h3 class="display-6 text-center mb-4 font-size-25 font-weight-bold">Personal Information</h3>
                    <div class="form-group justify-content-center" >
                            ...
                            <div class="form-check form-check-inline justify-content-center align-content-center text-center">
                                ...
                                <label class="form-check-label" for="governement">Government (Employee or other agency)</label>
                            </div>
                        
                        </div>

                        <div class="form-group">
                            <label for="gender font-weight-bold">Sex</label><br>
                            <div class="form-check form-check-inline">
                        ...
                        <div class="form-group">
                            <label for="date font-weight-bold">Date</label>
                        ...
                        <div class="form-group">
                            <label for="location">Region of Residence</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <label class="form-check-label" for="org">Association</label>
                            </div>
                            <div class="form-check form-check-inline">
            ...
            <div style="font-family: Arial, sans-serif; font-size: 15px;">
                <p class="m-0">Instructions: Check mark (/) your answer to the Citizen's Charter (CC) questions. Citizen's Charter is an official document that reflects the services of a government agency/office including requirements, fees, and processing time among others.</p>    
            </div>
        </div>
        <p class="m-0 font-weight-bold" style="font-family: Arial, sans-serif; font-size: 17px;">CC1</p>
        <div style="font-family: Arial, sans-serif; font-size: 15px;">
            <p class="font-weight-bold">1. Which of the following best describes your awareness of a CC?</p>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="radio3" onclick="enableInputcc()">
                    3. I learned of the CC when I saw this office's CC.
                </label>
            </div>
            <div class="form-check">
                ...
                <label class="form-check-label" for="radio4" onclick="disableInputcc()">
                    4. I don't know what a CC is and I did not see one in this office. Answer 'N/A' to CC2 and CC3.
                </label>
            </div>
            <p class="m-0 font-weight-bold" style="font-family: Arial, sans-serif; font-size: 17px;">CC2</p>
        <div style="font-family: Arial, sans-serif; font-size: 15px;">
            <p class="font-weight-bold">2. If aware of CC (answered in 1-3 of CC1), would you say that the CC of this office was...?</p>
        ...
        <div style="font-family: Arial, sans-serif; font-size: 15px;">
            <p class="font-weight-bold">3. If aware of CC (answered codes 1-3 of CC1), how much did the CC help you in your transaction?</p>
