                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center align-content-start justify-content-center" style= "border: 1px solid #dee2e6;"> <span class="emoji" style="font-size: 3em;">&#x1F614; </span><br>Strongly Disagree</th>
                            <th scope="col" class="text-center align-content-start justify-content-center" style= "border: 1px solid #dee2e6;"> <span class="emoji" style="font-size: 3em;">&#x1F641; </span><br>Disagree</th>
                            <th scope="col" class="text-center align-content-start justify-content-center" style= "border: 1px solid #dee2e6;"> <span class="emoji" style="font-size: 3em;">&#128528; </span><br>Neither Agree nor Disagree</th>
                            <th scope="col" class="text-center align-content-start justify-content-center" style= "border: 1px solid #dee2e6;"> <span class="emoji" style="font-size: 3em;">&#128578; </span><br>Agree</th>
                            <th scope="col" class="text-center align-content-start justify-content-center"> <span class="emoji" style="font-size: 3em;">&#128522; </span><br>Strongly Agree</th>

                        </tr>
                    </thead>
                    <form method="POST" action="{{route('submitsqd2surveyenglish')}}" enctype="multipart/form-data">
                        @csrf
                    ...
                    <tbody>
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD5. I paid a reasonable amount of fees for my transaction</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD6. I feel the office was fair to everyone, or "walang palakasan", during my transaction</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD7. I was treated courteously by the staff, and (if asked for help), the staff was helpful</td>
                        ...
                        <tr>
                            <td style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; text-align: left;">SQD8. I got what I needed from the government office, or (if denied) denial of the request was sufficiently explained to me</td>
