...
class AdminController extends Controller
{
    public function home(){
        ...
        $clientList = Client::whereDate('created_at', Carbon::today()->setTimezone('Asia/Manila'))->orderBy('service_availed', 'asc')->get();
        ...
        return view('admin.artadash', compact( 'clientList', 'getClientFilledSqd1', 'getTodayClients', 'getClientFilledSqd5', 'getClientSqd1Evaluation','getClientSqd1Evaluation2','getClientSqd1Evaluation3','getClientSqd1Evaluation4','getClientSqd1Evaluation5',
